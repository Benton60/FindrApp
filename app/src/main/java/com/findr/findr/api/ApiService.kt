...
interface ApiService {
    ...
    @GET("files/download/post/{author}/{postID}/{filePath}")
    suspend fun downloadPostPhoto(@Path("author") author: String, @Path("postID") postID: Long, @Path("filePath") filePath: String): ResponseBody
    @Multipart
