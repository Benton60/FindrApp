...
interface ApiService {
    ...
    @GET("posts/byPage/{id}/{longitude}/{latitude}")
    suspend fun getPostsByPage(@Path("id") id: Int, @Path("longitude") longitude: Double, @Path("latitude") latitude: Double): List<Post>
